...
#     if len(linha) != n:
#         print("Numero de elementos inválido!")
#         exit()
#     matriz.append(linha)
...
def forma_escada_reduzida(matriz):
    num_linhas = len(matriz) # Atribui o numero de linhas da matriz
    num_colunas = len(matriz[0]) # Atribui o numero de colunas da matriz
    ...
    for col in range(num_colunas):
        ...
        linha_pivo = linha #Começa a procurar o pivo na linha atual
        while linha_pivo < num_linhas and matriz[linha_pivo][col] == 0: 
            # Enquanto a linha_pivo for menor que o numero de linhas e o elemento da coluna atual for igual a 0, incrementa a linha_pivo
            linha_pivo += 1
        ...
        fator_pivo = matriz[linha][col] # Peag o valor do pivo
        ...
        linha += 1 # Incrementa a linha para procurar o proximo pivô
